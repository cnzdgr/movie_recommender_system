...
movies_metadata.csv: 
Contains all metadata regarding movies. Title, tagline(short description), original language are especially important.
...
credits.csv:
contains names of important cast members, as stringfied JSON object
